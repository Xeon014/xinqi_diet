...
const STEPS = [
  ...
  { key: "goal", title: "目标热量", description: "参考预估基础日消耗，自行设置每天目标热量。", required: true },
];
...
Page({
  data: {
    ...
    submitting: false,
    formulaBmrPreview: "--",
    baseCaloriesHint: "暂无法预估基础日消耗，请先完善基础代谢",
    birthDateColumns: [[], [], []],
  ...
  refreshFormulaMeta() {
    ...
    this.setData({
      ...
      baseCaloriesHint: recommendedBaseCalories == null
        ? "暂无法预估基础日消耗，请先完善基础代谢"
        : `预估基础日消耗约 ${recommendedBaseCalories} kcal/天`,
    });
  },
