...
public class MealRecordQueryService {
    ...
    List<MealRecord> findRecordsByUserAndDate(Long userId, LocalDate date) {
        return mealRecordRepository.findByUserAndDate(userId, date);
    }

    List<MealRecord> findRecordsByUserAndDateRange(Long userId, LocalDate startDate, LocalDate endDate) {
